//
//  GoodMasterListView.swift
//  shensuo
//
//  Created by 陈鸿庆 on 2021/4/8.
//

import UIKit

class GoodCompanyListView: UIView,UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate {
    ...
    lazy var nodataView : UIView = { () -> UIView in
        ...
        let tip = UILabel.initSomeThing(title: "暂无机构", titleColor: .black, font: .MediumFont(size: 16), ali: .center)
        view.addSubview(tip)
    ...
    var topTitle = UILabel.initSomeThing(title: "优质机构榜", titleColor: .white, font: .SemiboldFont(size: 18), ali: .center)
    var pageNum = 1
    var type = 1{
        didSet{
            if type == 1 {
    ...
    let topBgImg = UIImageView.initWithName(imgName: "company_top_bg")
    let topTitleImg = UIImageView.initWithName(imgName: "company_top_title")
    let headView = UIView()
    ...
    let btnArr = [UIButton.initTitle(title: "销量最高", fontSize: 16, titleColor: .init(hex: "#333333")),UIButton.initTitle(title: "人气最高", fontSize: 16, titleColor: .init(hex: "#333333")),UIButton.initTitle(title: "新秀机构", fontSize: 16, titleColor: .init(hex: "#333333"))]
    ...
    override init(frame: CGRect) {
        ...
        topBgImg.contentMode = .scaleToFill
    ...
    func getNetInfo(){
        ...
        NetworkProvider.request(.getOrganizationTop(pageNumber: self.pageNum, pageSize: 10, topType: self.type)) { result in
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        self.nodataView.isHidden = models.count > 0
        return self.models.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell : GoodCompanyListCell? = tableView.dequeueReusableCell(withIdentifier: "GoodCompanyListCell") as? GoodCompanyListCell
        if cell == nil {
            cell = GoodCompanyListCell.init(style: .default, reuseIdentifier: "GoodCompanyListCell")
        }
