...
class SearchSelTitleListView: UIView {
    ...
    var titles : [String] = ["课程","方案","动态","美丽日记","美丽相册","用户"]
    var subselIndex = 0
    ...
    override init(frame: CGRect) {
        ...
        dataSource.widthForTitleClosure = { str in
            return CGFloat(str.length * 16 + 30)
        }
...
extension SearchSelTitleListView : JXSegmentedViewDelegate{
